...
TORCH_LIBRARY(onednn, m) {
  ...
  m.def(TORCH_SELECTIVE_SCHEMA("onednn::qlinear_pointwise.tensor(Tensor qx, Tensor qw, Tensor w_scale, Tensor w_zero_point, Tensor x_scale, Tensor x_zero_point, Tensor? bias, float output_scale, int output_zero_point, ScalarType? output_dtype, str post_op_name, Scalar?[] post_op_args, str post_op_algorithm) -> Tensor"));
