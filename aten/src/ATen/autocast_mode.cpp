...
TORCH_LIBRARY_IMPL(aten, AutocastCPU, m) {
  ...
  KERNEL_CPU(ADD_NS(conv_transpose1d), "conv_transpose1d", Tensor (const Tensor &, const Tensor &, const c10::optional<Tensor> &, IntArrayRef, IntArrayRef, IntArrayRef, int64_t, IntArrayRef), lower_precision_fp)
  KERNEL_CPU(ADD_NS(conv_transpose2d), "conv_transpose2d.input", Tensor (const Tensor &, const Tensor &, const c10::optional<Tensor> &, IntArrayRef, IntArrayRef, IntArrayRef, int64_t, IntArrayRef), lower_precision_fp)
  KERNEL_CPU(ADD_NS(conv_transpose3d), "conv_transpose3d.input", Tensor (const Tensor &, const Tensor &, const c10::optional<Tensor> &, IntArrayRef, IntArrayRef, IntArrayRef, int64_t, IntArrayRef), lower_precision_fp)
  KERNEL_CPU(ADD_NS(layer_norm), "layer_norm", Tensor (const Tensor &, IntArrayRef, const c10::optional<Tensor> &, const c10::optional<Tensor> &, double, bool), lower_precision_fp)
  ...
  KERNEL_CPU(ADD_NS(renorm), "renorm", Tensor(const Tensor &, const at::Scalar &, int64_t, const at::Scalar &), fp32)
  ...
  KERNEL_CPU(ADD_NS(max_pool1d), "max_pool1d", Tensor(const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, IntArrayRef, bool), fp32)
  ...
  KERNEL_CPU(ADD_NS(leaky_relu), "leaky_relu", Tensor(const Tensor &, const Scalar &), fp32)
  ...
  KERNEL_CPU(ADD_NS(rrelu), "rrelu", Tensor(const Tensor &, const at::Scalar &, const at::Scalar &, bool, c10::optional<at::Generator>), fp32)
  ...
  KERNEL_CPU(ADD_NS(special_exp2), "special_exp2", Tensor(const Tensor &), fp32)
  KERNEL_CPU(ADD_NS(special_gammaln), "special_gammaln", Tensor(const Tensor &), fp32)
  ...
  KERNEL_CPU(ADD_NS(linalg_cholesky), "linalg_cholesky", Tensor(const Tensor &), fp32)
  ...
  m.impl(TORCH_SELECTIVE_NAME("aten::frexp.Tensor"),
