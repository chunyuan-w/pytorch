    ...
    def default_configs():
        def _conv_params_list():
            ...
            return [
                ...
                # fallback to native when thread=1
                # resnet50 shapes
                [1, 1, 64, 56, 56, 64, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 64, 56, 56, 256, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 256, 56, 56, 64, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 256, 56, 56, 128, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 128, 28, 28, 512, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 512, 28, 28, 128, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 512, 28, 28, 256, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 256, 14, 14, 1024, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 1024, 14, 14, 256, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 1024, 14, 14, 512, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 512, 7, 7, 2048, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 2048, 7, 7, 512, 0, 1, 1, 1], # thnn when thread=1

                # resnext101_32x8d shapes
                [1, 1, 256, 56, 56, 256, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 256, 56, 56, 512, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 512, 28, 28, 512, 0, 1, 1, 1], # thnn when thread=1
                [1, 1, 1024, 14, 14, 1024, 0, 1, 1, 1], # thnn when thread=1
