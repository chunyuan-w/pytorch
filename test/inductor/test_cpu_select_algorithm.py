...
class TestSelectAlgorithm(BaseTestSelectAlgorithm):
    ...
    # @parametrize("batch_size", (384,))
    # @parametrize("in_features", (1024,))
    # @parametrize("seq_lens", (768,))
    # @parametrize("out_features", (3072,))
    ...
    def test_linear_with_indirect_indexing(
        ...
        class M(torch.nn.Module):
            ...
            def forward(self, add_6, add_4):
                ...
                # File: /home/chunyuan/miniforge3/envs/inductor/lib/python3.10/site-packages/transformers/pytorch_utils.py:105 in forward, code: x = x.view(size_out)
                ...
                # File: /home/chunyuan/miniforge3/envs/inductor/lib/python3.10/site-packages/transformers/activations.py:56 in forward, code: return 0.5 * input * (1.0 + torch.tanh(math.sqrt(2.0 / math.pi) * (input + 0.044715 * torch.pow(input, 3.0))))
                ...
                # File: /home/chunyuan/miniforge3/envs/inductor/lib/python3.10/site-packages/transformers/pytorch_utils.py:104 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        ...
        y = torch.randn(batch_size, in_features, seq_lens)
