...
at::Tensor call(at::Tensor arg0_1) {
    ...
    auto buf0 = at::empty_strided(c10::DimVector({1,s0,s1,1}), c10::DimVector({s0*s1, s1, 1, s0*s1}), arg0_1.options());
    auto buf1 = at::empty_strided(c10::DimVector({1,s0,s1,s1}), c10::DimVector({s0*s1*s1, s1*s1, s1, 1}), arg0_1.options());
    auto buf2 = buf0;
    auto buf3 = buf1;
