...
class TestQuantizeJitPasses(QuantizationTestCase):
    ...
    def test_skip_dequant_constant_prop(self):
        ...
        # TODO: After skipping dequant during Constant Propagation, the resulting graph will be:
        ...
        FileCheck().check("aten::quantize_per_tensor").check_next("aten::dequantize"
        ).check_not(
            ...
            "aten::quantize_per_tensor").check_next("aten::dequantize"
        ).run(
            freezed.graph
        )
