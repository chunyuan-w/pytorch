    ...
    def _register_weight_pack_pass():
        ...
        def linear(match, *args, **kwargs):
            ...
            with graph.inserting_before(linear_node):
                ...
                # MKL packed matrix can't be copied to a different address because the internal implementation depends on the alignment of internally-stored metadata.
                # In aot mode, we need to firstly save the packed weight, when loading it, it will be in a different address which doesn't work.
